...
urlpatterns = [
    ...
    url(r'^introduction1/(?P<video_task>\w+)/$', views.introduction1),
    url(r'^self_emotion/(?P<video_task>\w+)/$', views.self_emotion),
    url(r'^task/(?P<category>\w+)/(?P<video_task>\w+)/$', views.task),
